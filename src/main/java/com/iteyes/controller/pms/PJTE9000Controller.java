...
public class PJTE9000Controller {
	...
	public @ResponseBody boolean create(@RequestBody PJTE9000DTO PJTE9000) throws Exception{
		...
		for(int i=0; i<PJTE9000.getCreatedRows().size(); i++) {
			...
			PJTE9000C.setInp_dt(PJTE9000.getCreatedRows().get(i).getInp_dt());
			PJTE9000C.setWth_dt(PJTE9000.getCreatedRows().get(i).getWth_dt());
	...
	public @ResponseBody boolean update(HttpServletRequest request, @RequestBody PJTE9000DTO PJTE9000) throws Exception{
		...
		for(int i=0; i<PJTE9000.getUpdatedRows().size(); i++) {
			...
			PJTE9000U.setDel_yn(PJTE9000.getUpdatedRows().get(i).getDel_yn());
			PJTE9000U.setInp_dt(PJTE9000.getUpdatedRows().get(i).getInp_dt());
			PJTE9000U.setWth_dt(PJTE9000.getUpdatedRows().get(i).getWth_dt());
	...
	public @ResponseBody boolean backup_update(HttpServletRequest request, @RequestBody PJTE9000DTO PJTE9000) throws Exception{
		...
		result = pjte9000Service.delete_9000_74(PJTE9000D);
		result = pjte9000Service.delete_9000_75(PJTE9000D);
		result = pjte9000Service.delete_9000_76(PJTE9000D);
		...
		result = pjte9000Service.insert_9000_75(PJTE9000C);
		result = pjte9000Service.insert_9000_76(PJTE9000C);
	...
	public @ResponseBody boolean excel_upload(@RequestBody PJTE9000DTO PJTE9000) throws Exception{
		...
		for(int i=0; i<PJTE9000.getRowDatas().size(); i++) {
			...
			PJTE9000C.setInp_dt(PJTE9000.getRowDatas().get(i).getInp_dt());
			PJTE9000C.setWth_dt(PJTE9000.getRowDatas().get(i).getWth_dt());
